  ...
  return (
    ...
    >
      <span
        ...
        style={{ width: size * 1.15, height: size * 1.15, background: "var(--brand-gradient)" }}
      >
        <svg width={size * 0.7} height={size * 0.7} viewBox="0 0 24 24" fill="none" stroke="#0a0a0b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SiteNav({
  ...
  active?: "home" | "setup" | "review" | "catalog";
}) {
  const links: Array<{ href: string; label: string; key: typeof active }> = [
    { href: "/", label: "Overview", key: "home" },
    { href: "/setup", label: "1 · Setup", key: "setup" },
    { href: "/review", label: "2 · Review", key: "review" },
